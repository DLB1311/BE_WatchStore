...
class CustomerDAO {
    ...
    async findByEmail(email) {
        try {
          const query = `SELECT * FROM KHACHHANG WHERE Email = @email`;
    ...
    async findByPhoneNumber(phone) {
        try {
          const query = `SELECT * FROM KHACHHANG WHERE SDT = @phone`;
    ...
    async signUpCustomer({ Ho, Ten, GioiTinh, NgaySinh, DiaChi, SDT, Email, Password }) {
